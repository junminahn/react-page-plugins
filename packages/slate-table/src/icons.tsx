...
export const italic = 'M15 20H7v-2h2.927l2.116-12H9V4h8v2h-2.927l-2.116 12H15z';

export const underline = 'M8 3v9a4 4 0 1 0 8 0V3h2v9a6 6 0 1 1-12 0V3h2zM4 20h16v2H4v-2z';
...
export const heading1 = 'M13 20h-2v-7H4v7H2V4h2v7h7V4h2v16zm8-12v12h-2v-9.796l-2 .536V8.67L19.5 8H21z';
...
export const heading = 'M17 11V4h2v17h-2v-8H7v8H5V4h2v7z';
...
const icons = {
  ...
  'insert-row-bottom': insertRowBottom,
  'insert-row-top': insertRowTop,
  'insert-column-left': insertColumnLeft,
  'insert-column-right': insertColumnRight,
};

export const Icon = ({ disabled = false, name }) => {
  return (
    <IconSVG disabled={disabled}>
